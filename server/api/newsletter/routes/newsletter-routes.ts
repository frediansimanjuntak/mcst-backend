...
export class NewsletterRoutes {
    static init(router: express.Router) {
      router
        .route('/api/newsletters/:name_url') 
      ...
      router
        .route('/api/newsletters/:name_url/:idnewsletter')
      ...
      router
        .route('/api/newsletters/:name_url/update/:idnewsletter')
        .post(auth.isAuthenticated(), NewsletterController.updateNewsletter); 

      router
        .route('/api/newsletters/:name_url/release/:idnewsletter')
